      ...
      <div className="flex items-center justify-center h-screen bg-gradient-to-br from-orange-800 via-white to-green-800">
        <PopupComponent  isOpen={showPopUp} onCloseFn={()=>onCloseFn()} popUpTitle={'Forgot Password'} isBtnVisible={false}>
          <div className='flex flex-col w-full gap-y-4 justify-center items-center'>
            <input type='' className='px-2 py-2  border-2 border-gray-400 rounded-md outline-none focus:border-sky-500 w-full' placeholder='email'/>
            <p className='bg-blue-500 px-2 py-2 rounded-md font-semibold text-white text-center cursor-pointer w-fit'>Sent OTP</p>
          </div>
        </PopupComponent>
