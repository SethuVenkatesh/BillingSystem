...
const InputComponent = ({inputType,labelName,inputName,inputValue,companyDetails,setCompanyDetails}) => {
  ...
  return (
    <div className='relative mb-4'>
        <input type={inputType} id="floating_outlined" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent border border-gray-300 rounded-md appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " onChange={handleChange} name={inputName}/>
